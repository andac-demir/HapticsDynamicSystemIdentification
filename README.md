...
The hybrid dynamic model is a mixed input system that integrates the time samples with sparse wavelet coefficients from different resolution levels. We benchmark the performance of these three dynamic models against eachother across each participant and discuss the potential how these models can guide external stimulation parameters for haptic interaction simulation in scenarios, including teleoperations and virtual environments.
